      ...
      <ul className="flex gap-1">
        {equippedWeapon ? (
          ...
          <li className="relative w-[64px] h-[64px] rounded border border-gray-400">
            <small className="absolute top-0 w-full text-center opacity-70">Weapon Empty</small>
          </li>
        )}
        {equippedArmor ? (
          <li className="relative w-[64px]">
          ...
          <li className="relative w-[64px] h-[64px] rounded border border-gray-400">
            <small className="absolute top-0 w-full text-center opacity-70">Armor Empty</small>
          </li>
        )}
      </ul>
    </div>
